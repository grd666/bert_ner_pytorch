...
#Model Initialization
    ...
    parser.add_argument("--trainset", type=str, default="./dataset/train_dataset.txt")
    parser.add_argument("--validset", type=str, default="./dataset/val_dataset.txt")
    parser.add_argument("--testset", type=str, default="./dataset/test_dataset.txt")
